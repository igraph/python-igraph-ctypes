...
igraph_neighbors.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_int_t), igraph_integer_t, igraph_neimode_t]
...
igraph_edges.argtypes = [POINTER(igraph_t), igraph_es_t, POINTER(igraph_vector_int_t)]
...
igraph_incident.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_int_t), igraph_integer_t, igraph_neimode_t]
...
igraph_lcf_vector = _lib.igraph_lcf_vector
igraph_lcf_vector.restype = handle_igraph_error_t
igraph_lcf_vector.argtypes = [POINTER(igraph_t), igraph_integer_t, POINTER(igraph_vector_int_t), igraph_integer_t]
...
igraph_are_connected = _lib.igraph_are_connected
igraph_are_connected.restype = handle_igraph_error_t
igraph_are_connected.argtypes = [POINTER(igraph_t), igraph_integer_t, igraph_integer_t, POINTER(igraph_bool_t)]

igraph_diameter = _lib.igraph_diameter
igraph_diameter.restype = handle_igraph_error_t
igraph_diameter.argtypes = [POINTER(igraph_t), POINTER(igraph_real_t), POINTER(igraph_integer_t), POINTER(igraph_integer_t), POINTER(igraph_vector_int_t), POINTER(igraph_vector_int_t), igraph_bool_t, igraph_bool_t]

igraph_diameter_dijkstra = _lib.igraph_diameter_dijkstra
igraph_diameter_dijkstra.restype = handle_igraph_error_t
igraph_diameter_dijkstra.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), POINTER(igraph_real_t), POINTER(igraph_integer_t), POINTER(igraph_integer_t), POINTER(igraph_vector_int_t), POINTER(igraph_vector_int_t), igraph_bool_t, igraph_bool_t]
...
igraph_get_all_simple_paths.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_int_t), igraph_integer_t, igraph_vs_t, igraph_integer_t, igraph_neimode_t]
...
igraph_average_path_length.argtypes = [POINTER(igraph_t), POINTER(igraph_real_t), POINTER(igraph_real_t), igraph_bool_t, igraph_bool_t]

igraph_average_path_length_dijkstra = _lib.igraph_average_path_length_dijkstra
igraph_average_path_length_dijkstra.restype = handle_igraph_error_t
igraph_average_path_length_dijkstra.argtypes = [POINTER(igraph_t), POINTER(igraph_real_t), POINTER(igraph_real_t), POINTER(igraph_vector_t), igraph_bool_t, igraph_bool_t]
...
igraph_eigenvector_centrality.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), POINTER(igraph_real_t), igraph_bool_t, igraph_bool_t, POINTER(igraph_vector_t), POINTER(igraph_arpack_options_t)]

igraph_hub_score = _lib.igraph_hub_score
igraph_hub_score.restype = handle_igraph_error_t
igraph_hub_score.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), POINTER(igraph_real_t), igraph_bool_t, POINTER(igraph_vector_t), POINTER(igraph_arpack_options_t)]

igraph_authority_score = _lib.igraph_authority_score
igraph_authority_score.restype = handle_igraph_error_t
igraph_authority_score.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), POINTER(igraph_real_t), igraph_bool_t, POINTER(igraph_vector_t), POINTER(igraph_arpack_options_t)]
...
igraph_hub_and_authority_scores.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), POINTER(igraph_vector_t), POINTER(igraph_real_t), igraph_bool_t, POINTER(igraph_vector_t), POINTER(igraph_arpack_options_t)]
...
igraph_centralization_eigenvector_centrality.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), POINTER(igraph_real_t), igraph_bool_t, igraph_bool_t, POINTER(igraph_arpack_options_t), POINTER(igraph_real_t), POINTER(igraph_real_t), igraph_bool_t]
...
igraph_centralization_eigenvector_centrality_tmax.argtypes = [POINTER(igraph_t), igraph_integer_t, igraph_bool_t, igraph_bool_t, POINTER(igraph_real_t)]
...
igraph_eccentricity.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), igraph_vs_t, igraph_neimode_t]

igraph_eccentricity_dijkstra = _lib.igraph_eccentricity_dijkstra
igraph_eccentricity_dijkstra.restype = handle_igraph_error_t
igraph_eccentricity_dijkstra.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), POINTER(igraph_vector_t), igraph_vs_t, igraph_neimode_t]
...
igraph_pseudo_diameter.argtypes = [POINTER(igraph_t), POINTER(igraph_real_t), igraph_integer_t, POINTER(igraph_integer_t), POINTER(igraph_integer_t), igraph_bool_t, igraph_bool_t]

igraph_pseudo_diameter_dijkstra = _lib.igraph_pseudo_diameter_dijkstra
igraph_pseudo_diameter_dijkstra.restype = handle_igraph_error_t
igraph_pseudo_diameter_dijkstra.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), POINTER(igraph_real_t), igraph_integer_t, POINTER(igraph_integer_t), POINTER(igraph_integer_t), igraph_bool_t, igraph_bool_t]
...
igraph_random_edge_walk = _lib.igraph_random_edge_walk
igraph_random_edge_walk.restype = handle_igraph_error_t
igraph_random_edge_walk.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), POINTER(igraph_vector_int_t), igraph_integer_t, igraph_neimode_t, igraph_integer_t, igraph_random_walk_stuck_t]

igraph_global_efficiency = _lib.igraph_global_efficiency
igraph_global_efficiency.restype = handle_igraph_error_t
igraph_global_efficiency.argtypes = [POINTER(igraph_t), POINTER(igraph_real_t), POINTER(igraph_vector_t), igraph_bool_t]

igraph_local_efficiency = _lib.igraph_local_efficiency
igraph_local_efficiency.restype = handle_igraph_error_t
igraph_local_efficiency.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), igraph_vs_t, POINTER(igraph_vector_t), igraph_bool_t, igraph_neimode_t]
...
igraph_average_local_efficiency.argtypes = [POINTER(igraph_t), POINTER(igraph_real_t), POINTER(igraph_vector_t), igraph_bool_t, igraph_neimode_t]

igraph_transitive_closure_dag = _lib.igraph_transitive_closure_dag
igraph_transitive_closure_dag.restype = handle_igraph_error_t
igraph_transitive_closure_dag.argtypes = [POINTER(igraph_t), POINTER(igraph_t)]
...
igraph_bipartite_game.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_bool_t), igraph_erdos_renyi_t, igraph_integer_t, igraph_integer_t, igraph_real_t, igraph_integer_t, igraph_bool_t, igraph_neimode_t]
...
igraph_community_edge_betweenness.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_int_t), POINTER(igraph_vector_t), POINTER(igraph_matrix_int_t), POINTER(igraph_vector_int_t), POINTER(igraph_vector_t), POINTER(igraph_vector_int_t), igraph_bool_t, POINTER(igraph_vector_t)]
...
igraph_community_label_propagation.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_int_t), igraph_neimode_t, POINTER(igraph_vector_t), POINTER(igraph_vector_int_t), POINTER(igraph_vector_bool_t)]
...
igraph_community_optimal_modularity.argtypes = [POINTER(igraph_t), POINTER(igraph_real_t), POINTER(igraph_vector_int_t), POINTER(igraph_vector_t)]
...
igraph_motifs_randesu_estimate.argtypes = [POINTER(igraph_t), POINTER(igraph_integer_t), igraph_integer_t, POINTER(igraph_vector_t), igraph_integer_t, POINTER(igraph_vector_int_t)]

igraph_motifs_randesu_no = _lib.igraph_motifs_randesu_no
igraph_motifs_randesu_no.restype = handle_igraph_error_t
igraph_motifs_randesu_no.argtypes = [POINTER(igraph_t), POINTER(igraph_integer_t), igraph_integer_t, POINTER(igraph_vector_t)]
...
igraph_adjacent_triangles = _lib.igraph_adjacent_triangles
igraph_adjacent_triangles.restype = handle_igraph_error_t
igraph_adjacent_triangles.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_t), igraph_vs_t]
...
igraph_canonical_permutation.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_int_t), POINTER(igraph_vector_int_t), igraph_bliss_sh_t, POINTER(igraph_bliss_info_t)]
...
igraph_automorphism_group.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_int_t), POINTER(igraph_vector_int_list_t), igraph_bliss_sh_t, POINTER(igraph_bliss_info_t)]

igraph_subisomorphic_lad = _lib.igraph_subisomorphic_lad
igraph_subisomorphic_lad.restype = handle_igraph_error_t
igraph_subisomorphic_lad.argtypes = [POINTER(igraph_t), POINTER(igraph_t), POINTER(igraph_vector_int_list_t), POINTER(igraph_bool_t), POINTER(igraph_vector_int_t), POINTER(igraph_vector_int_list_t), igraph_bool_t, igraph_integer_t]
...
igraph_minimum_spanning_tree.argtypes = [POINTER(igraph_t), POINTER(igraph_vector_int_t), POINTER(igraph_vector_t)]

igraph_minimum_spanning_tree_unweighted = _lib.igraph_minimum_spanning_tree_unweighted
igraph_minimum_spanning_tree_unweighted.restype = handle_igraph_error_t
igraph_minimum_spanning_tree_unweighted.argtypes = [POINTER(igraph_t), POINTER(igraph_t)]

igraph_minimum_spanning_tree_prim = _lib.igraph_minimum_spanning_tree_prim
igraph_minimum_spanning_tree_prim.restype = handle_igraph_error_t
igraph_minimum_spanning_tree_prim.argtypes = [POINTER(igraph_t), POINTER(igraph_t), POINTER(igraph_vector_t)]
